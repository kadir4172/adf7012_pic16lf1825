...
unsigned char sine_table[26] = {0x11,0x14,0x18,0x1b,0x1e,0x20,0x21,0x21,0x20,0x1e,0x1b,0x18,0x14,0x11,0xd,0x9,0x6,0x3,0x1,0x0,0x0,0x1,0x3,0x6,0x9,0xd};

unsigned char sine_table2[14] = {0x10,0x16,0x1c,0x1f,0x1f,0x1c,0x16,0x10,0x9,0x3,0x0,0x0,0x3,0x9};

unsigned char adc_sonuc_high = 0;
unsigned char adc_sonuc_low  = 0;

bool Spi_Byte_Send(unsigned char);
/*
 * 
 */
...
void Delay_ms(unsigned int time_to_delay)
{
  systick_counter = 0;
...
bool Spi_Byte_Send(unsigned char data){
